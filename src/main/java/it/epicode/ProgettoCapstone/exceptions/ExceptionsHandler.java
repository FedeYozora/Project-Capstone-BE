package it.epicode.ProgettoCapstone.exceptions;
...
public class ExceptionsHandler {
    ...
    @ExceptionHandler(it.epicode.ProgettoCapstone.exceptions.UUIDNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND) // 404
    public ErrorsPayload handleNotFound(it.epicode.ProgettoCapstone.exceptions.UUIDNotFoundException ex) {
        return new ErrorsPayload(ex.getMessage(), LocalDateTime.now());
    }

    @ExceptionHandler(it.epicode.ProgettoCapstone.exceptions.UnauthorizedException.class)
